...
def chase():
    ...
    pygame.display.set_caption("Hilf Chase! und fange die Katzen!")
    ...
    cat_imgs = []
    cats_path = Path(__file__).parent.parent / "resources/images/cats"
    ...
    while running:
        try:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and remaining > 0:
            ...
            timer_text = font.render(f"Zeit: {remaining // 1000 + 1}s", True, (255, 255, 255))
